...
Function
=========================================================
This program is going to do following things:
[0]- Get file list
[1]- Read csv files
[2]- Get rows need to be dropped
[3]- Get x and y for train and predict
[4]- Drop bad rows
[5]- Do regression and prediction
[6]- Ouput data for regression and prediction, also output result
"""
...
class DoRegression:
    ...
    def drop_row(self, x_, aim_rows, ):
        ...
        for seq_i in range(15):
            # aim range
            aim_range = list(range((seq_i+1)*100-aim_rows, (seq_i+1)*100))
            # aim average value
    ...
    def main(self, ):
        ...
        # write log
        self.writecsv(pd.DataFrame(self.log), "train&predict_log.csv", )
